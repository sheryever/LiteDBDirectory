...
{
    public class LiteDbDirectory : Directory
    {
        ...
        public override bool FileExists(string name)
            => _fileMetaDataCollection.Count(fm => fm.Name == name) > 0;

        public override long FileLength(string name)
            => FileHelper.GetContentFileDataLength(_db, name);
